...
# Тест на обновление склада когда не передан priceTypeSystemId
# Тест на обновление склада когда не передан name
# Тест на обновление склада когда не передан currency
# Тест на обновление склада когда priceTypeSystemId передан как int
# Тест на обновление склада когда name передан как int
# Тест на обновление склада когда в currency передано число как string (Пример "643")
# Тест на обновление склада когда в currency передана строка string (Пример "ываыа")
