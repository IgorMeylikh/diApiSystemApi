...
from configuration import SERVICE_URL, CREATE_WAREHOUSES_PAGE, INTERNAL_LOGIN, INTERNAL_PASSWORD, INTERNAL_HEADERS, EMPTY_JSON, CREATE_ONE_WAREHOUSE, CREATE_SEVERAL_WAREHOUSES, CREATE_ISSET_WAREHOUSE_SYSTEM_ID, CREATE_SEVERAL_ONE_ISSET_WAREHOUSE_SYSTEM_ID, CREATE_ONE_WAREHOUSE_WITHOUT_WAREHOUSE_SYSTEM_ID, CREATE_ONE_WAREHOUSE_WITHOUT_NAME, CREATE_ONE_WAREHOUSE_WAREHOUSE_SYSTEM_ID_IS_INT, CREATE_ONE_WAREHOUSE_NAME_WAREHOUSE_IS_INT
