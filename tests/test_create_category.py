...
from configuration import SERVICE_URL, CREATE_CATEGORIES_PAGE, INTERNAL_LOGIN, INTERNAL_PASSWORD, HEADERS, ONE_CATEGORY_JSON, REPEAT_ONE_CATEGORY_JSON, VALIDATE_CATEGORY_AND_REPEAT_CATEGORY_JSON, VALIDATE_CATEGORY_AND_REPEAT_HIMSELF_CATEGORY_JSON
