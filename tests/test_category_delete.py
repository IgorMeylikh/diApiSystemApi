...
from configuration import SERVICE_URL, DELETE_CATEGORIES_PAGE, INTERNAL_LOGIN, INTERNAL_PASSWORD, HEADERS, EMPTY_JSON, DELETE_ONE_CATEGORY_JSON, DELETE_SEVERAL_CATEGORIES_JSON
