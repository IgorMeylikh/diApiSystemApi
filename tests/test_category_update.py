...
from configuration import SERVICE_URL, UPDATE_CATEGORIES_PAGE, INTERNAL_LOGIN, INTERNAL_PASSWORD, HEADERS, UPDATE_ONE_CATEGORY_JSON, UPDATE_ONE_NOT_ISSET_CATEGORY_JSON, UPDATE_NOT_REQUIRED_JSON, UPDATE_NOT_VALID_JSON, EMPTY_JSON, UPDATE_CATEGORY_WITHOUT_CATEGORY_SYSTEM_ID_JSON
