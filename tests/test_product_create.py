...
from configuration import SERVICE_URL, CREATE_PRODUCTS_PAGE, INTERNAL_LOGIN, INTERNAL_PASSWORD, HEADERS, CREATE_ONE_PRODUCT_WITH_OPTIONAL_JSON, CREATE_ONE_PRODUCT_WITHOUT_OPTIONAL_JSON, EMPTY_JSON
...
#Тест на создание njdfhf с передачей 1 валидного элемента с указанием необязательных ключей
